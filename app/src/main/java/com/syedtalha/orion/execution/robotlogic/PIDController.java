package com.syedtalha.orion.execution.robotlogic;
//----------------------------------------------------------------------------
...
public class PIDController {
 ...
 private double m_maximumOutput; //= 100.0;       // |maximum output|
 private double m_minimumOutput; //= -100.0;      // |minimum output|
 private double m_maximumInput;// = 3.14;                // maximum input - limit setpoint to this
 private double m_minimumInput ;//= -3.14;                // minimum input - limit setpoint to this
 ...
 public void setCurrentInput(double input){
     m_input = input;
 }
